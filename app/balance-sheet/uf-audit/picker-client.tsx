...
export function UfAuditPicker({ clientLinks }: { clientLinks: ClientLink[] }) {
  ...
  function open(c: ClientLink) {
    ...
    router.push(`/balance-sheet/${c.id}/uf-audit`);
  }
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-ink-slate mt-0.5">
              ...
              scans every Undeposited Funds payment, flags orphans + duplicates,
              and clears them in bulk (voids, $0 deposits, bank deposits, JEs)
            </p>
          </div>
        </div>
